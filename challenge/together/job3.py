...
train_fname = '../data/train_5.csv'
test_fname = '../data/test_5.csv'
...
clf = ExtraTreesClassifier(n_estimators=tree_per_forest, max_leaf_nodes=n_leaf, oob_score=False, min_samples_leaf=1, min_samples_split=1, n_jobs=n_thread)
